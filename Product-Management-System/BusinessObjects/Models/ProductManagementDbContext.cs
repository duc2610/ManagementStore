...
public partial class ProductManagementDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__Location__E7FEA47739248CDD");
        ...
        {
            entity.HasKey(e => new { e.ProductId, e.StartDate }).HasName("PK__ProductC__D0ED59226CC3F377");
        ...
        {
            entity.HasKey(e => new { e.ProductId, e.LocationId }).HasName("PK__ProductI__DA732CAA3C178CD0");
            ...
            entity.HasOne(d => d.Location).WithMany(p => p.ProductInventories)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProductIn__Locat__4AB81AF0");
        ...
        {
            entity.HasKey(e => e.ModelId).HasName("PK__ProductM__E8D7A1CC999C3345");
        ...
        {
            entity.HasKey(e => new { e.ProductId, e.StartDate }).HasName("PK__ProductP__D0ED5922C113F6B9");
        ...
        {
            entity.HasKey(e => e.SubcategoryId).HasName("PK__ProductS__9C4E707DC715879E");
